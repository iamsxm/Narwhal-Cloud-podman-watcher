...
REPORT_INTERVAL_VALUE="$(existing_or_default REPORT_INTERVAL 300)"
ACTION_POLL_INTERVAL_VALUE="$(existing_or_default ACTION_POLL_INTERVAL 10)"
CONTAINER_RUNTIMES_VALUE="$(existing_or_default CONTAINER_RUNTIMES auto)"
DOCKER_MONITOR_MODE_VALUE="$(existing_or_default DOCKER_MONITOR_MODE notice)"
MONITORED_IMAGE_PATTERNS_VALUE="$(existing_or_default MONITORED_IMAGE_PATTERNS '*')"
MONITORED_INCUS_PATTERNS_VALUE="$(existing_or_default MONITORED_INCUS_PATTERNS '*')"
INCUS_PROJECT_VALUE="$(existing_or_default INCUS_PROJECT default)"
SECURITY_MONITOR_ENABLED_VALUE="$(existing_or_default SECURITY_MONITOR_ENABLED true)"

cat >"$ENV_FILE" <<EOF_ENV
SERVER_URL=$SERVER_URL
SHARED_SECRET=$SHARED_SECRET
HOST_ID=$HOST_ID
REPORT_INTERVAL=$REPORT_INTERVAL_VALUE
ACTION_POLL_INTERVAL=$ACTION_POLL_INTERVAL_VALUE
CONTAINER_RUNTIMES=$CONTAINER_RUNTIMES_VALUE
DOCKER_MONITOR_MODE=$DOCKER_MONITOR_MODE_VALUE
MONITORED_IMAGE_PATTERNS=$MONITORED_IMAGE_PATTERNS_VALUE
MONITORED_INCUS_PATTERNS=$MONITORED_INCUS_PATTERNS_VALUE
INCUS_PROJECT=$INCUS_PROJECT_VALUE
SECURITY_MONITOR_ENABLED=$SECURITY_MONITOR_ENABLED_VALUE
EOF_ENV
chmod 0600 "$ENV_FILE"
